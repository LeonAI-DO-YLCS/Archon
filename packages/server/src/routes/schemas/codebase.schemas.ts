...
export const updateCodebaseBodySchema = z
  .object({
    allowEnvKeys: z.boolean().optional(),
    aiAssistantType: z.enum(['claude', 'codex', 'ollama', 'lmstudio', 'litellm']).optional(),
  })
  .refine(b => b.allowEnvKeys !== undefined || b.aiAssistantType !== undefined, {
    message: 'Provide at least one of "allowEnvKeys" or "aiAssistantType"',
  })

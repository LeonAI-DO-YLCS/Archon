...
const experimentalAssistantConfigSchema = z.object({
  enabled: z.boolean(),
  baseUrl: z.string(),
...
export const safeConfigSchema = z
  .object({
    ...
    assistants: z.object({
      ...
      ollama: experimentalAssistantConfigSchema,
      lmstudio: experimentalAssistantConfigSchema,
      litellm: experimentalAssistantConfigSchema,
    }),
    streaming: z.object({
...
export const updateAssistantConfigBodySchema = z
  .object({
    ...
    codex: z
      ...
      .optional(),
    ollama: experimentalAssistantConfigSchema.partial().optional(),
    lmstudio: experimentalAssistantConfigSchema.partial().optional(),
    litellm: experimentalAssistantConfigSchema.partial().optional(),
  })

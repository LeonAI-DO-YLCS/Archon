...
export function usesNativeAssistantSession(assistantType: string): boolean {
  return assistantType === 'claude' || assistantType === 'codex';
}
...
export async function createSession(data: {
  ...
  const assistantSessionId = usesNativeAssistantSession(data.ai_assistant_type)

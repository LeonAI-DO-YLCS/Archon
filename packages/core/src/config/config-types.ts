...
export interface ExperimentalAssistantDefaults {
  enabled?: boolean;
  baseUrl?: string;
  defaultModel?: string;
}
...
export interface GlobalConfig {
  ...
  assistants?: {
    ...
    ollama?: ExperimentalAssistantDefaults;
    lmstudio?: ExperimentalAssistantDefaults;
    litellm?: ExperimentalAssistantDefaults;
  };
...
export interface MergedConfig {
  ...
  assistants: {
    claude: ClaudeAssistantDefaults;
    codex: AssistantDefaults;
    ollama: Required<ExperimentalAssistantDefaults>;
    lmstudio: Required<ExperimentalAssistantDefaults>;
    litellm: Required<ExperimentalAssistantDefaults>;
  };
  streaming: {
    telegram: 'stream' | 'batch';
    discord: 'stream' | 'batch';

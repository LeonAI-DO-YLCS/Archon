...
function mergeGlobalConfig(defaults: MergedConfig, global: GlobalConfig): MergedConfig {
  const result: MergedConfig = {
    ...
    assistants: {
      ...
      lmstudio: { ...defaults.assistants.lmstudio },
      litellm: { ...defaults.assistants.litellm },
    },
  };
  ...
  if (global.assistants?.lmstudio) {
    result.assistants.lmstudio = {
      ...result.assistants.lmstudio,
      ...global.assistants.lmstudio,
    };
  }
  if (global.assistants?.litellm) {
    result.assistants.litellm = {
      ...result.assistants.litellm,
      ...global.assistants.litellm,
    };
  }
...
function mergeRepoConfig(merged: MergedConfig, repo: RepoConfig): MergedConfig {
  const result: MergedConfig = {
    ...
    assistants: {
      ...
      lmstudio: { ...merged.assistants.lmstudio },
      litellm: { ...merged.assistants.litellm },
    },
  };
  ...
  if (repo.assistants?.lmstudio) {
    result.assistants.lmstudio = {
      ...result.assistants.lmstudio,
      ...repo.assistants.lmstudio,
    };
  }
  if (repo.assistants?.litellm) {
    result.assistants.litellm = {
      ...result.assistants.litellm,
      ...repo.assistants.litellm,
    };
  }
  ...
  try {
    ...
    if (updates.assistants) {
      merged.assistants = {
        ...
        lmstudio: { ...current.assistants?.lmstudio, ...updates.assistants.lmstudio },
        litellm: { ...current.assistants?.litellm, ...updates.assistants.litellm },
      };
    }
...
export function toSafeConfig(config: MergedConfig): SafeConfig {
  return {
    ...
    assistants: {
      ...
      ollama: {
        enabled: config.assistants.ollama.enabled,
        baseUrl: config.assistants.ollama.baseUrl,
        defaultModel: config.assistants.ollama.defaultModel,
      },
      lmstudio: {
        enabled: config.assistants.lmstudio.enabled,
        baseUrl: config.assistants.lmstudio.baseUrl,
        defaultModel: config.assistants.lmstudio.defaultModel,
      },
      litellm: {
        enabled: config.assistants.litellm.enabled,
        baseUrl: config.assistants.litellm.baseUrl,
        defaultModel: config.assistants.litellm.defaultModel,
      },
    },
    streaming: {
